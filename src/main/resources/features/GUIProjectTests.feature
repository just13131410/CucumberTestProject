...
Funktionalität: Vorgangs-Dashboard
  ...
  # EnterpriseSteps-Steps sind aktuell reine Platzhalter (nur Logging, keine echte
  # Playwright-Interaktion/Assertion) - mit @ignore markiert, bis sie real implementiert
  # sind, damit sie nicht fälschlich als bestandene Tests durchgehen.
  @negativ @ignore
